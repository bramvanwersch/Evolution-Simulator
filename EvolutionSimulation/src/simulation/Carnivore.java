...
public class Carnivore extends Species{
	...
	/**
	 * Function that will calculate the enery consumption based on a formula. The speed and size are corr
	 */
	 ...
	 * see if the carnivore has eaten recently.
	 */
	public void move() {
		eatTimeCheck();
		if (getEnergy() > 0) {
	 ...
	 * value is set to 50 procent of the maximum value.
	 */
	public int getSize() {
